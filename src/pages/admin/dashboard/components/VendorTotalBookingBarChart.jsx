...
import { getBookingsCountForGraphApi } from '../../../../apis/api';
import Loader from '../../../../components/Loader';

const VendorTotalBookingsBarChart = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const bookingResponse = await getBookingsCountForGraphApi();
...
export default VendorTotalBookingsBarChart;
