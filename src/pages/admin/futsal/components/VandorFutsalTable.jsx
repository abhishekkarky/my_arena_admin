    ...
    return (
        <>
            <div class="relative overflow-auto">
                                    ...
                                    <tr class="border-b hover:bg-white">
                                        ...
                                        <td class="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <button onClick={handleFutsalEditModal} className='text-neutral-700 hover:text-red-500'>
                                                    <Edit size={21} />
                                                </button>
                ...
                <EditFutsalModal open={isFutsalEditModalOpen} onClose={() => setIsFutsalEditModalOpen(false)} />
            </div>
        </>
    )
}
